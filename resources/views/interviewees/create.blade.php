...
<div class="row">
 <form class="form-horizontal" method="POST" action="{{ route('interviewees.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
       ...
       <div class="form-group{{ $errors->has('job_post_id') ? ' has-error' : '' }}">
        ...
        <div class="form-group{{ $errors->has('portfolio') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <input id="portfolio" type="text" class="form-control" name="portfolio" value="{{ old('portfolio') }}" >
        ...
        <div class="form-group{{ $errors->has('channel') ? ' has-error' : '' }}">
            ...
            <div class="col-md-6">
                <label class="radio-inline"><input type="radio" name="channel" value="0" checked>自社サイト</label>
                <label class="radio-inline"><input type="radio" name="channel" value="1">紹介会社</label>
                <label class="radio-inline"><input type="radio" name="channel" value="2">媒体</label>
                <label class="radio-inline"><input type="radio" name="channel" value="3">社員紹介</label>
                <label class="radio-inline"><input type="radio" name="channel" value="4">その他</label>
